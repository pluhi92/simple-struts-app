package com.pluhi.web.service.db.nickname;
...
public class OrderedByNicknameListDesc {
	...
	public OrderedByNicknameListDesc() {
		try {
	...
	public List<UserData> findDataBy(String nickname, String age) throws SQLException {
		...
		try (Connection conn = ds.getConnection(); PreparedStatement ps = conn.prepareStatement(DATA_SQL);) {
